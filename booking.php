<?php 
    ...
    if(mysqli_num_rows($result) == 1)
    {
        ...
        if (isset($_POST['book'])) {
            ...
            if(count($errors) == 0)
            {
                $sql = "INSERT INTO booking (date, start_time, end_time, numberofperson, full_name, email, phone, product_id, total) VALUES ('$date', '$start_time', '$end_time', '$numberofperson', '$full_name', '$email', '$phone', '$product_id', '$total')";
